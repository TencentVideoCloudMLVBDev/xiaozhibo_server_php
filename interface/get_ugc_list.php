...
class get_ugc_list extends AbstractInterface
{
    ...
    {
        interface_log(INFO, EC_OK,"get_ugc_list args=" . var_export($this->_args, true));
        ...
        if($ret == 0) {
            $ret = $dao_live->getUGCList($start_pos, $count,$result_list, $error_message);
        }
        ...
        interface_log(INFO, EC_OK, 'get_ugc_list::process() succeed');
        return true;
    }
}