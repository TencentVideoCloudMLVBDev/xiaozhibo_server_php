...
class upload_ugc extends AbstractInterface
{
    ...
    {
        interface_log(INFO, EC_OK,"upload_ugc args=" . var_export($this->_args, true));
        ...
        $ret = $dao_live->addUGCData($this->_args['userid'],
            $this->_args['file_id'],
            $this->_args['play_url'],
            $this->_args['title'],
        ...
        interface_log(INFO, EC_OK, 'upload_ugc::process() succeed ');
    }
}